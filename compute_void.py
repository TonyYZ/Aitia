...
def drawGuideTree(tree, precision=1, lastProbDicts=[], layerMode=False, normalize=True, verbose=False,
    ...
    for frameI in frameILst:
        pixels = np.zeros((height, width), dtype=float)
                    ...
                    for frameI in calcSeq:
                        ...
                        if tree[0] in ['ż', 'm', 'ċ']:
                            ...
                            if 0 <= roundY < bigHeight and 0 <= roundX < bigWidth:
                                pixelDict[frameI][roundY, roundX] += fluctuation
                        ...
                        for j in range(width):
                            ...
                            for frameI in calcSeq:
                                ...
                                if 0 <= roundY < bigHeight and \
                                        0 <= roundX < bigWidth:
                                    pixelDict[frameI][roundY, roundX] += staticPattern[i]
